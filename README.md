...
This module should later be backed by:

* IEEE power systems references
* NREL grid optimization resources
* DOE grid modernization references
* SCIP documentation
* CasADi documentation
* IPOPT documentation
* SMAC documentation
* quantum optimization papers or documentation
...
Power Grid Optimization Better Reading training module framework created and ready for expansion.
